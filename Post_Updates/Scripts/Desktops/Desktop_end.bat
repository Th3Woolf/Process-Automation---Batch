...
rundll32 printui.dll PrintUIEntry /in /n\printerserver\mainprinter
xcopy e:\Office_2024_Inst c:\temp /s /e
cd C:\temp\Office_2024
setup.exe /configure configuration_Office2024.xml
\\server.com.br\Wallpaper\WallPaper.bat
pause